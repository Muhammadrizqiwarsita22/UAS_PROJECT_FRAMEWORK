            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex justify-between mb-6">
                        <a href="{{ route('mahasiswa-export-excel') }}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-700 transition">
                            Export Excel
                        </a>
                        <a href="{{ route('mahasiswa.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
